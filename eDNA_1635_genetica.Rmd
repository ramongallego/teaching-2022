...
.pull-right[
<img src="images/SeqbySyn.png" alt="16S"  />
...
### .center[.nord12[Pregunta 2]: Hay distintas comunidades asociadas con <br> Temperature and pH]
...
*  .huge.bold[Usando la estimación de Khangaonkar et al, 2019]

*  .huge.bold[La predicción muestra algunos valores .nord13[ extremos] ]

* .huge.bold[La mayoría de los valores .nord13[se ven en el escenario actual]]
